...
var G__12146 = devtools.prefs.pref.call(null,v);
v = G__12146;
continue;
} else {
return v;
...
}catch (e12149){var _e__11821__auto__ = e12149;
return false;
}})();
...
}catch (e12153){var _e__11821__auto__ = e12153;
return false;
}})();
...
}catch (e12155){var _e__11821__auto__ = e12155;
return false;
}}
}
});
...
var vec__12157 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__12157,(0),null);
var name = cljs.core.nth.call(null,vec__12157,(1),null);
...
return cljs.core.some.call(null,(function (p1__12160_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__12160_SHARP_);
}),template);
});
