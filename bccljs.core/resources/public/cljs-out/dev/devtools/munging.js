...
var o12041 = temp__5455__auto__;
var temp__5455__auto____$1 = (o12041["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o12042 = temp__5455__auto____$1;
return (o12042["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__11814__auto__ = f;
return (o__11814__auto__["toString"]).call(o__11814__auto__);
} else {
return "";
}
}catch (e12043){var _ = e12043;
return "";
}});
...
try{var o__11814__auto___12045 = t;
(o__11814__auto___12045["cljs$lang$ctorPrWriter"]).call(o__11814__auto___12045,t,writer);
}catch (e12044){var __12046 = e12044;
}
...
var char_code = (function (){var o__11814__auto__ = (new String(char$));
return (o__11814__auto__["charCodeAt"]).call(o__11814__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__11814__auto__ = String;
return (o__11814__auto__["fromCharCode"]).call(o__11814__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12047 = num_code;
switch (G__12047) {
case (1):
return (185);
...
var o__11814__auto__ = String;
return (o__11814__auto__["fromCharCode"]).call(o__11814__auto__,superscript_code);
});
/**
...
}catch (e12049){var _e__11821__auto__ = e12049;
return false;
}})())){
...
var vec__12050 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__12050,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o12053 = temp__5455__auto__;
var temp__5455__auto____$1 = (o12053["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o12054 = temp__5455__auto____$1;
return (o12054["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___12061 = arguments.length;
var i__4731__auto___12062 = (0);
while(true){
if((i__4731__auto___12062 < len__4730__auto___12061)){
args__4736__auto__.push((arguments[i__4731__auto___12062]));

var G__12063 = (i__4731__auto___12062 + (1));
i__4731__auto___12062 = G__12063;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12057){
var vec__12058 = p__12057;
var ns_detector = cljs.core.nth.call(null,vec__12058,(0),null);
...
var G__12064 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__12065 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__12064;
remaining_tokens = G__12065;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12055){
var G__12056 = cljs.core.first.call(null,seq12055);
var seq12055__$1 = cljs.core.next.call(null,seq12055);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12056,seq12055__$1);
});
...
var vec__12069 = cljs.core.split_with.call(null,(function (p1__12068_SHARP_){
return cljs.core.not_EQ_.call(null,p1__12068_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__12069,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__12069,(1),null);
...
var vec__12075 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__12075,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__12075,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__12078 = cljs.core.rest.call(null,remaining_tokens);
var G__12079 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__12078;
name_tokens = G__12079;
continue;
} else {
...
var vec__12082 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__12082,(0),null);
var arity = cljs.core.nth.call(null,vec__12082,(1),null);
var vec__12085 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__12085,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__12085,(1),null);
var vec__12088 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__12088,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__12088,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__12088,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__12088,(3),null);
...
var vec__12094 = result;
var munged_ns = cljs.core.nth.call(null,vec__12094,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__12094,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__12094,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__12094,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__12094,(4),null);
var arity = cljs.core.nth.call(null,vec__12094,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__12098 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__12098,(0),null);
var args = cljs.core.nth.call(null,vec__12098,(1),null);
var vec__12101 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__12101,(0),null);
var name = cljs.core.nth.call(null,vec__12101,(1),null);
...
var G__12104 = (arity + (1));
var G__12105 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12106){
var vec__12107 = p__12106;
var arity = cljs.core.nth.call(null,vec__12107,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__12107,(1),null);
...
return cljs.core.get.call(null,arities,p1__12110_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__12111_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12114){
var vec__12115 = p__12114;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__12115,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12112){
var G__12113 = cljs.core.first.call(null,seq12112);
var seq12112__$1 = cljs.core.next.call(null,seq12112);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12113,seq12112__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__12123__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__12123__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__12123__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__12123__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12124 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__12124,(0),null);
var fn_name = cljs.core.nth.call(null,vec__12124,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__12124,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__12124,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__12124,(4),null);
var arity = cljs.core.nth.call(null,vec__12124,(5),null);
...
var o__11814__auto__ = f;
return (o__11814__auto__["getBasis"]).call(o__11814__auto__);
});
/**
...
}catch (e12128){var _e__11821__auto__ = e12128;
...
var G__12129 = (obj[cljs.core.first.call(null,path)]);
var G__12130 = cljs.core.rest.call(null,path);
obj = G__12129;
path = G__12130;
continue;
} else {
...
return (function (accum,p__12131){
var vec__12132 = p__12131;
var bit = cljs.core.nth.call(null,vec__12132,(0),null);
var protocol = cljs.core.nth.call(null,vec__12132,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12135){
var vec__12136 = p__12135;
var ns = cljs.core.nth.call(null,vec__12136,(0),null);
var name = cljs.core.nth.call(null,vec__12136,(1),null);
var selector = cljs.core.nth.call(null,vec__12136,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__12141,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__12141,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__12141,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__12139_SHARP_){
return (obj[cljs.core.first.call(null,p1__12139_SHARP_)]);
});})(name,sorted_matches,vec__12141,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
